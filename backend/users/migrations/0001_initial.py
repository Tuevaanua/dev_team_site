...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(help_text='Например: Senior 3D Artist, Frontend Developer', max_length=100, verbose_name='Должность/Роль')),
                ('bio', models.TextField(blank=True, verbose_name='Биография и Опыт')),
                ('skills', models.CharField(blank=True, max_length=500, verbose_name='Стек и Навыки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_url', models.CharField(blank=True, max_length=255, null=True, verbose_name='Ссылка для перехода (клику)')),
